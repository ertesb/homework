...
if __name__ == "__main__":
    ...
    cash_calculator.add_record(Record(amount=300, comment="Сереге за обед"))
    cash_calculator.add_record(Record(amount=3000, comment="бар в Танин др", date="08.11.2019"))
    print(cash_calculator.get_today_cash_remained('rub'))

    calories_calculator = CaloriesCalculator(1500)
    calories_calculator.add_record(Record(amount=100, comment='пироженка'))
    calories_calculator.add_record(Record(amount=250, comment='пицца'))
